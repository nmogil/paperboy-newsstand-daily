...
const FaqItem = ({ question, answer, isOpen, toggle }: FaqItemProps) => {
  return (
    <div className="border-b border-newsprint/10 last:border-0">
      <button
        className="flex justify-between items-center w-full py-5 text-left font-display font-semibold focus:outline-none"
        onClick={toggle}
      >
        <span>{question}</span>
